# Makit Individual Contributor License Agreement
...
contributors to Us. This is a legally binding document, so please read it
...
Contributions Submitted to Us by signing electronically via the CLA Assistant
bot on a pull request (by commenting the sentence it instructs you to post).

This Agreement is based on the Harmony Individual Contributor License Agreement
(HA-CLA-I) Version 1.0, using **Outbound License Option Five**, which permits Us
...
please contact license@getmakit.dev for the Entity (corporate) version of this
Agreement.

*This Agreement is derived from the Harmony Individual Contributor License
Agreement (HA-CLA-I) Version 1.0, which is licensed under a Creative Commons
