# SPEC-01 — makit daemon & local control plane
...
the desktop app (SPEC-03) — can drive a *running* makit: show/refresh the QR,
...
### Out
- CLI client verbs like `makit qr`/`makit devices` — those are **SPEC-02** (they
