# SPEC-github-gateway-and-budget — Centralised GitHub gateway + API budget indicator

**Status:** proposed · **Date:** 2026-07-31 · **Depends on:** SPEC-pr-status-and-actions (PR status & actions), SPEC-decomposition-and-dedup (decomposition), SPEC-repo-centric-home (repo-centric home)
...
- **Webhooks.** No public HTTPS endpoint on a laptop (SPEC-pr-status-and-actions research §5).
