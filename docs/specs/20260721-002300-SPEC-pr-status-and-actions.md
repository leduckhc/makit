# SPEC-pr-status-and-actions — Live PR status + PR action pills (desktop)

**Status:** In progress · **Depends on:** SPEC-desktop-chat-app (desktop chat), SPEC-repo-centric-home
...
Materialize the SPEC-desktop-chat-app Phase-5 "PR workflows" roadmap and fix the concrete bug
