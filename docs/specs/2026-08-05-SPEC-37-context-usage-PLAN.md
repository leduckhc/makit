# SPEC-37 (context usage) — Amendment plan: correct usage, and the extension's own repo

Spec: [`2026-08-05-SPEC-37-context-usage.md`](./2026-08-05-SPEC-37-context-usage.md)
...
This is not the original build plan — SPEC-37 shipped in `fe9659b`. It is the plan for the
...
SPEC-37 recorded the pill row as "pre-existing and untouched". Re-measured in the running app:
...
- The right fix is the SPEC-31 shape: fold the legacy `model`/`thinking`/`mode` trio into one
