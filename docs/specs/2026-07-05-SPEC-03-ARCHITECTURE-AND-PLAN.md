...
**Depends on:** SPEC-01 (daemon control socket)
**Blocks:** —
...
- QR/devices/status endpoints live in SPEC-01 daemon, not in the WS server
...
**Responsibility:** Talk to the unix socket (SPEC-01), wrap responses.
...
- **Recommendation:** **Option A** — simpler, fewer deps. Mimics the SPEC-01 `control-client.ts` closely.
