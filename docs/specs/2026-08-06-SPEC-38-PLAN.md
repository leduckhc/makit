...
**1762 app tests, 928 server tests, both analyzers clean.** They are recorded here because the spec
...
Verify: `flutter test test/ui/widgets/pr_signals_test.dart` — **62 tests**, pinning every row of spec
...
Verify: `flutter test test/desktop/chat/pr_bar_test.dart` — **38 tests**.
...
Final: **1762 app tests, 928 server tests**, `flutter analyze` and `pnpm typecheck` clean.
