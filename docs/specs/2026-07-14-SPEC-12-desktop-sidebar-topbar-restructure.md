# SPEC-12 — Desktop sidebar & topbar restructure (foldable/resizable + slim chrome)

**Status:** In progress · **Depends on:** SPEC-10 (desktop chat app), SPEC-11 (repo-centric home)
