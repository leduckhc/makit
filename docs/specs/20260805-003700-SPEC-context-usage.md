# SPEC-context-usage — Context usage: tokens vs limit, per session

**Status:** Implemented · **Amended 2026-08-06** (see below) · **Priority:** P3
**Branch:** `feat-context-usage`, amended on `fix/token-usage`
**Plan:** [`20260805-003700-SPEC-context-usage-PLAN.md`](./20260805-003700-SPEC-context-usage-PLAN.md)
**Mockup:** [`mockups/context-usage.html`](../../mockups/context-usage.html)
**Depends on:** SPEC-acp-config-options-unified-composer (composer footer selectors), SPEC-github-gateway-and-budget (budget-panel precedent), SPEC-computer-use (pi-extension + bridge precedent)
...
does not re-broadcast the sessions snapshot (SPEC-server-hotpath-and-state P2) — usage changes nothing in the
session list DTO.
...
the same constraint SPEC-computer-use hit. Environment variables *do* propagate
...
> **Amended by [SPEC-composer-footer-space](./20260806-004000-SPEC-composer-footer-space.md) (2026-08-06).** The
...
> SPEC-composer-footer-space gives the ring its own intrinsic `footerTrailing` slot. The **ring decision itself
