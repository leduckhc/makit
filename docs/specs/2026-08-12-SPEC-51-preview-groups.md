# SPEC-51 — Preview groups: one disposable worktree tab

**Status:** Implemented · **Priority:** P2 · **Surface:** desktop chat (`app/lib/desktop/chat/`), desktop settings
**Depends on:** SPEC-30 (tab groups — the thing that accumulates), SPEC-28 (the split/tab tree a group renders)
...
SPEC-30 decision 15 made the sidebar worktree row *navigate*: clicking a branch
...
- Mobile. Groups are a desktop-window concept (SPEC-30).
