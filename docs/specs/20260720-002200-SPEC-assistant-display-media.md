# SPEC-assistant-display-media — Assistant display media (images, video, gifs)

**Status:** phases 1–3 implemented (images + GIF + local file refs); phase 4
(video/audio) not started · **Depends on:** SPEC-server-adapter-consolidation (adapter consolidation),
SPEC-app-chat-simplification (app chat), ACP transition · **Blocks:** —
