# SPEC-repo-centric-home — Repo-centric mobile home (worktrees, diff stats, PRs)

**Status:** Implemented · **Depends on:** SPEC-session-in-pane-spawning (session spawning), SPEC-composer-adaptive-input (composer)
