...
void main() {
  testWidgets('searching a repo-only term shows the result under the repo name', (t) async {
    ...
    expect(find.text('No matches'), findsNothing, reason: 'the repo item must be found');
