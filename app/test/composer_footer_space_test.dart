...
/// SPEC-composer-footer-space — the composer footer at real widths, for the session shapes our
...
void main() {
  ...
  group(
    'SPEC-composer-footer-space — shipping shapes: no overflow, visible ring, 320…700pt',
    () {
  ...
  group(
    'SPEC-composer-footer-space — a four-option shape (no adapter emits this today)',
    () {
  ...
  group(
    'SPEC-composer-footer-space — the model label is readable at 375pt (criterion 3)',
    () {
      ...
      testWidgets('375pt (SE/mini) clips pi by a hair, not by a provider', (
        ...
        final shown = _paragraph(
          tester,
          find.text('Claude Opus 4.6'),
        ).size.width;
      ...
      testWidgets('the full provider/name stays in the tooltip', (
        tester,
      ) async {
        tester.view.physicalSize = const Size(375, 812);
        tester.view.devicePixelRatio = 1.0;
  ...
  group(
    'SPEC-composer-footer-space — a wide pane leaves every pill at its natural width',
    () {
      ...
      testWidgets('D4 — the pill row is not scrollable at any width', (
        ...
        // the ring exists to be glanceable without a tap (SPEC-context-usage).
  ...
  group(
    'SPEC-composer-footer-space — the chip gate measures what will actually be rendered',
    () {
