// SPEC-session-lifecycle-resume-list-delete: Session DTO carries `resumable`; codec parses it (default false).
import 'package:flutter_test/flutter_test.dart';
import 'package:makit/transport/codec.dart';

void main() {
  group(
    'Session resumable field (SPEC-session-lifecycle-resume-list-delete)',
    () {
      ...
      test(
        'decodeSessions parses closed=true (SPEC-session-lifecycle-resume-list-delete)',
        () {
          final sessions = WireCodec.decodeSessions([
            {
              'id': 's3',
  ...
  group('Session lineage fields (SPEC-cli-as-client D10)', () {
    test(
    ...
    test(
      'lineage defaults to null when absent (pre-SPEC-cli-as-client row, no throw)',
      () {
        final sessions = WireCodec.decodeSessions([
          {
            'id': 's2',
