# Makit Entity Contributor License Agreement

Thank you for your interest in contributing to Makit ("We" or "Us").

"Us" means **Khanh Chuong Le**, the maintainer and copyright holder of Makit,
and Our successors and assigns (including any company to which the Makit
copyright is later assigned).

This contributor agreement ("Agreement") documents the rights granted by
corporate contributors to Us. This is a legally binding document, so please
read it carefully before agreeing to it. The Agreement may cover more than one
software project managed by Us.

Use this Entity version when contributions are made on behalf of a company or
other legal entity (for example, work created by employees within the scope of
their employment). Individuals contributing on their own behalf should use the
[Individual CLA](./CLA.md) instead.

To execute this Agreement, an authorized signatory should complete and sign the
signature block at the end and send it to **license@getmakit.dev**.

This Agreement is based on the Harmony Entity Contributor License Agreement
(HA-CLA-E) Version 1.0, using **Outbound License Option Five**, which permits Us
to offer Makit under both open source (GPL-3.0-or-later) and commercial licenses.
...
license@getmakit.dev before Submitting.
...
source code control systems, and issue tracking systems that are managed by, or
on behalf of, Us for the purpose of discussing and improving the Material, but
...
the Material on the Submission Date (currently GPL-3.0-or-later).
...
(d) You have contacted Us at license@getmakit.dev if You do not own the
...
of the jurisdiction in which Us is domiciled, excluding its conflicts of law
...
International Sale of Goods ("UN Convention") and the parties intend to avoid the
...
*This Agreement is derived from the Harmony Entity Contributor License Agreement
(HA-CLA-E) Version 1.0, which is licensed under a Creative Commons Attribution
